#Write Python programs to demonstrate variables, data types (int, float, str, bool) and all operators (Arithmetic, Assignment, Comparison, Logical, Membership, Identity, Bitwise).
a = 9
b = 6
x = 5.55
name = "Python"
